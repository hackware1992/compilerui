...
public final class TabLayoutMediator2 {
    @NonNull
    private final SimpleTabLayout tabLayout;
    ...
    @Nullable private SimpleTabLayout.OnTabSelectedListener onTabSelectedListener;
    ...
    public interface TabConfigurationStrategy {
         ...
         */
        void onConfigureTab(@NonNull SimpleTabLayout.Tab tab, int position);
    }

    public TabLayoutMediator2(
            @NonNull SimpleTabLayout tabLayout,
    ...
    void populateTabsFromPagerAdapter() {
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapterCount; i++) {
                SimpleTabLayout.Tab tab = tabLayout.newTab();
    ...
    private static class TabLayoutOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        @NonNull private final WeakReference<SimpleTabLayout> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        TabLayoutOnPageChangeCallback(SimpleTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            SimpleTabLayout tabLayout = tabLayoutRef.get();
            if (tabLayout != null) {
     ...
     */
    private static class ViewPagerOnTabSelectedListener implements SimpleTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(@NonNull SimpleTabLayout.Tab tab) {
